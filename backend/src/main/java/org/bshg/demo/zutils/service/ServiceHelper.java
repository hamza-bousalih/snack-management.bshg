package org.bshg.demo.zutils.service;

import org.bshg.demo.zutils.entity.BaseEntity;
import org.bshg.demo.zutils.util.ListUtil;
...
public class ServiceHelper {
    ...
    public static < T> void deleteById(T item, Function<T, Long> id, Consumer<Long> deleterById) {
        if (item == null || id.apply(item) == null) return;
        deleterById.accept(id.apply(item));
    }
}
